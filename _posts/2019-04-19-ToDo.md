---
Header: "Future Lines of Inquiry"
layout: post # if this were a page, you would write "page" instead. They layouts are subtly different. Try it to see what happens.
title:  "Future Lines of Inquiry"
subtitle: "The various directions this project could go"
date:   2019-04-19 12:56:13 -0400
...
background: '/img/gazaResortEnt.jpg' # notice how the image referenced is in your project's /img/posts/ folder.
---
<head>
  <style>
    p{text-indent: 50px;}
...
<body>
<p>What is Google's policy when it comes to what can be posted on Street View Images? What about on Google Map's photos and videos, which don't appear on Street View?</p>

<p>How do these objects complicate databases and data collection?</p>
</body>
---
